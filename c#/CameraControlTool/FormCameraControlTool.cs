...
namespace CameraControlTool
{
    ...
    public partial class FormCameraControlTool : Form
    {
        ...
        private void buttonSnapshotOutputFrame_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Insira o nome da pessoa");
            }
            else
            { 
            ...
            Bitmap bitmap = cameraControl.SnapshotOutputImage();
                ...
                /*Save to blob*/
                UploadFileToStorage(bitmap, textBoxName.Text);
        ...
        /*
        private static async Task<string> SaveToBlob(Bitmap photo, string fileName)
        {
            string connectionString = System.Configuration.ConfigurationSettings.AppSettings["StorageConnectionString"];
            ...
            BlobContainerClient containerClient = await blobServiceClient.CreateBlobContainerAsync("photos");
        ...
        public static async Task<bool> UploadFileToStorage(Bitmap photo, string fileName)
        {
            string[] paths = { Environment.CurrentDirectory.ToString(), "known_faces", fileName };
            ...
            string[] pathsfile = { Environment.CurrentDirectory.ToString(), "known_faces", fileName, idimage };
